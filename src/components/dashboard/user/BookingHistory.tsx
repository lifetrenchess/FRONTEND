...
import { Calendar, MapPin, Clock, Package, Star } from 'lucide-react';
              ...
              {bookings.map((booking) => (
                <div key={booking.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex gap-2 mt-4 pt-4 border-t">
                    <Button variant="ghost" size="sm" className="text-[#01E8B2] hover:text-[#01E8B2]/80">
                      View Details
                    </Button>
                    ...
                    {booking.status === 'COMPLETED' && (
                      <Button 
                        variant="ghost" 
                        size="sm" 
                        className="text-[#01E8B2] hover:text-[#01E8B2]/80"
